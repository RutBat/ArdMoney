...
<?php
		...
		echo "Данная почта уже зарегистрированна, <a class='text-success' href='auth.php'>авторизуйтесь</a>";
		exit;
	}
}
if ($num_rows == 0) {
	echo "Даной почте нельзя регистрироватся - свяжитесь с <a class='text-danger' href='https://rutbat.t.me'>администрацией</a> ";
	exit;
}
?>
