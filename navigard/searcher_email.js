$(document).ready(function() {
    ...
    // Поле поиска из файла 'index.php' имеет id='mail'
    $("#mail").keyup(function() {
        ...
        if (name === "") {
            ...
            $.ajax({
                ...
                url: "email_search.php", // Указываем путь к обработчику. То есть указывем куда будем отправлять данные на сервере.
                data: {
...
function fill(Value) {
    ...
    $('#mail').val(Value); // Берем значение элемента из результата поиска и добавляем его в значение поля поиска
